...
class DiscreteSAC(RlAlgorithm):
    ...
    def loss(self, samples):
        ...
        q1_logits, q2_logits = self.agent.q(*agent_inputs)
        ...
        new_action, log_pi, dist_info = self.agent.pi(*agent_inputs)

        log_target1, log_target2 = self.agent.q(*agent_inputs)
